...
public class Dijkstra {
    ...
    public static ResultadoDijkstra calcular(Grafo grafo, Vertice origem) {
        if (origem == null || !grafo.existeVertice(origem)) {
            throw new IllegalArgumentException("Vértice de origem inválido ou fora do grafo");
        }
        ...
        while (!fila.isEmpty()) {
            ...
            if (visitados.contains(atual)) {
                continue; // já processado com a menor distância possível, ignora entrada antiga
            }
            visitados.add(atual);
